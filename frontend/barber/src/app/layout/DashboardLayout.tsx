            ...
            <div className="flex items-center gap-4 ml-auto">
              ...
              {showLogoutMenu && (
                <>
                  ...
                  />
                  <div className="absolute top-full right-4 mt-2 w-56 bg-[#0a0a0a] border border-gold/20 rounded-xl shadow-2xl shadow-gold/10 overflow-hidden z-50 animate-fade-in">
                    <div className="p-3 border-b border-border flex items-center gap-3">
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-semibold text-text truncate">{(typeof window !== 'undefined' && JSON.parse(localStorage.getItem('barbershop_profile') || '{}')?.name) || 'Régua Máxima'}</p>
                      ...
                      <button
                        ...
                        className="flex-none w-8 h-8 flex items-center justify-center rounded-lg text-text/70 hover:text-gold hover:bg-gold/10 transition-colors"
