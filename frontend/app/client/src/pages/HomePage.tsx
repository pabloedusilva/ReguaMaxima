...
export default function HomePage() {
  ...
  // Simula carregamento inicial (substituir por chamadas de API reais quando o backend estiver pronto)
  useEffect(() => {
  ...
  return (
    <div className="grid gap-8 md:gap-10 relative skeleton-enter">
